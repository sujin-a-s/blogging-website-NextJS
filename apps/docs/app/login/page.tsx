...
export default function Signup(){
    ...
    const onLogin = async() =>{
        try{
            ...
            toast.success("redirecting to blogs page")
            router.push("/blogs")
           }else{
    ...
    return (
        ...
        <div className="bg-gray-200 rounded-md p-10">
            <div className="mb-3 text-center">{loading?<div className="items-center"><Spinner/></div>:"Login"}</div>
            ...
            <button onClick={onLogin} type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Login</button>
            </div>
            <div className=" mt-3 flex justify-center">
